  ...
  const plans = [
    {
      ...
      //   price: "$25",
      features: [
        "تمكنك من التواصل مع د. محمد لشرح وتقييم الحالة",
        "إرسال النظام الغذائي المخصص لكم",
        "المتابعة مع الدكتور شخصياً",
        "لا يوجد اتصال فى هذا الباقة",
      ],
      badge: "BASE",
    },
    {
      title: "استشارة ومتابعة",
      //   price: "$55",
      features: [
        " الاستشارة مكالمة عن طريق كوميرا ",
        "إرسال النظام الغذائي المخصص لكم",
    ...
    },
    {
      ...
      features: [
        "الاستشارة مكالمة عن طريق كوميرا",
        "إرسال النظام الغذائي المخصص لكم",
        "المتابعة لمدة شهر كامل مع الدكتور شخصياً",
        "مقابلة في نهاية الشهر لتقييم الوضع الصحي وخطة العلاج",
      ],
      badge: "FULL",
    },
