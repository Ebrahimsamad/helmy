      ...
      <div className="container mx-auto max-w-screen-lg">
        ...
        <div className="text-center md:text-right">
          ...
          >
            ...
            تكون جرثومة المعدة هي السبب الرئيسي. د. محمد حلمى يقدم لك الحل
            الأمثل لتشخيص وعلاج جرثومة المعدة بأحدث التقنيات الطبية. لا تدع
            الألم يؤثر على حياتك أكثر، اتخذ القرار الآن واستشر د. محمد حلمى
            لضمان صحة جهازك الهضمي والعودة لحياتك اليومية بكل راحة. أحجز موعدك
            الآن لتتخلص من الأعراض المزعجة.
          </p>
          ...
          >
            ...
            يقدم دكتور محمد حلمى برنامجًا علاجيًا متكاملاً وفعالًا للقضاء علي
