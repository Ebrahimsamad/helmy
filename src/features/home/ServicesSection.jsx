...
const services = [
  ...
  },
  {
    ...
    description:
      "لحل مشكلة دهون الكبد، يجب اتباع نظام غذائي صحي منخفض الدهون، ممارسة الرياضة بانتظام، فقدان الوزن الزائد، وتقليل تناول الكحول. بالإضافة إلى ذلك، من المهم استشارة الطبيب لإجراء الفحوصات اللازمة واتباع العلاج المناسب إذا تطلب الأمر .",
    image: "/12.jpg",
    link: "/جرثومة-المعدة",
  },
  {
    ...
    title: "مريض الاورام",
    description:
      "متابعة مرضى الأورام تشمل تقييم الحالة الصحية بشكل دوري، إجراء الفحوصات اللازمة مثل الأشعة والتحاليل، ومراقبة استجابة الجسم للعلاج. كما يتطلب دعمًا نفسيًا للتعامل مع الآثار الجانبية للعلاج، بالإضافة إلى تقديم النصائح حول التغذية السليمة والرعاية الصحية المستمرة .",
    image: "/14.jpg",
    link: "/جرثومة-المعدة",
  },
  {
    ...
    description:
      "مساعدة مرضى الغدد اللمفاوية تشمل تشخيص السبب بدقة، سواء كان عدوى أو التهابًا أو ورمًا، وتقديم العلاج المناسب مثل الأدوية أو الجراحة أو العلاج الكيميائي، مع متابعة طبية مستمرة لضمان التحسن .",
    image: "/16.jpg",
    link: "/جرثومة-المعدة",
  },
  {
